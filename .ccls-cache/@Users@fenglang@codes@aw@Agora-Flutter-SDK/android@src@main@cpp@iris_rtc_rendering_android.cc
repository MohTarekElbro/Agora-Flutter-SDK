...
Java_io_agora_iris_IrisRenderer_nativeStartRenderingToSurface(
...
Java_io_agora_iris_IrisRenderer_nativeStopRenderingToSurface(
...
extern "C" JNIEXPORT jlong JNICALL
Java_io_agora_iris_IrisRtcRendering_nativeInit(JNIEnv *env, jclass clazz,
                                               jlong iris_api_engine_handle) {
  auto *iris_rtc_rendering =
      agora::iris::IrisRtcRendering::Create((void *) iris_api_engine_handle);
  return reinterpret_cast<jlong>(iris_rtc_rendering);
}

extern "C" JNIEXPORT void JNICALL
Java_io_agora_iris_IrisRtcRendering_nativeDestroy(JNIEnv *env, jclass clazz,
                                                  jlong native_handle) {
  auto *iris_rtc_rendering =
      reinterpret_cast<agora::iris::IrisRtcRendering *>(native_handle);
  delete iris_rtc_rendering;
}